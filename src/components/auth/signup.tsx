...
import { initialSignupState, setLoginError, setLoginSuccess } from '@Store/reducers/auth.reducer';
import FastImage from 'react-native-fast-image';
import Animated, { FadeInDown, FadeInUp, SlideInLeft, SlideInRight, SlideOutLeft, SlideOutRight } from 'react-native-reanimated';
...
const Signup = ({ navigation }: RootStackGuestNavigation) => {
  const [user, setUser] = useState<SignupInterface>(initialSignupState);
